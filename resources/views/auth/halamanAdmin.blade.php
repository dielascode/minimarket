...
<head>
    ...
    <style>
        * {
        ...
        .hero {
            margin-top: 35px;
            background: linear-gradient(135deg, #eba225, #ad781b);
            border-radius: 25px;
            padding: 55px;
            color: white;
            position: relative;
    ...
    <main class="container">
        <section class="hero">
            <div class="position-relative" style="z-index: 2;">
                ...
                <p>
                    Selamat datang min. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis libero
